    ...
    <a href="{{ route('jobs.show', $job->id) }}" class="text-green-500 inline-flex items-center">Lire plus
        ...
        <div class="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4">
            ...
            <a href="{{route('jobs.edit',$job->id)}}" >
                <span class="text-gray-500 inline-flex items-center leading-none text-sm hover:text-blue-500">
            ...
            <a href="{{route('jobs.delete',$job->id)}}" >
                <span class="text-gray-500 inline-flex items-center leading-none text-sm hover:text-red-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
