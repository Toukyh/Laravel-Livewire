<header class="text-gray-600 dark:text-gray-400 dark:bg-gray-900 body-font">
    ...
    <a href="{{ route('login') }}" class="mr-3 inline-flex items-center  dark:text-white border-0 py-1 px-3 focus:outline-none hover:text-green-200 dark:hover:text-green-500 rounded text-base mt-4 md:mt-0">Log in
        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-1" viewBox="0 0 24 24">
